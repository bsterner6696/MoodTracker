...
/**
 * Helper class for showing and canceling mood bar
 * notifications.
 * <p>
...
public class MoodBar {
     ...
     */
    private static final String NOTIFICATION_TAG = "MoodBar";
     ...
     * presentation of mood bar notifications. Make
     * sure to follow the
    ...
    public static void notify(final Context context,
        ...
        final NotificationCompat.Builder builder = new NotificationCompat.Builder(context)
                ...
                .setSmallIcon(R.drawable.ic_stat_mood_bar)
